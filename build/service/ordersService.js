...
var addOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(orderData) {
    var orderId, orderDate, status, userId, total, address, cartItems, _yield$supabase$from$, error;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          status = "open";
          userId = orderData.userId, total = orderData.total, address = orderData.address, cartItems = orderData.cartItems;
          _context2.next = 6;
          return _connection["default"].from('orders').insert([{
            id: orderId,
            userId: userId,
            total: total,
            address: address,
          ...
          if (error) {
            ...
            cartItems.forEach( /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(item) {
                var productId, total, amount, _yield$supabase$from$2, error;
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 5;
                      return _connection["default"].from('orders_products').insert([{
                        orderId: orderId,
                        productId: productId,
                        total: total,
                        amount: amount
...
var getOrderById = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(orderId) {
    var _yield$supabase$from$3, data, error, newData;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _connection["default"].from('orders').select("\n        *,\n        orders_products: id (\n            total,\n            amount,\n            product: productId (\n                name\n            )\n        )").eq('id', orderId);
        case 2:
            ...
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(order) {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return _userService["default"].getUserById(order.userId);
                  case 2:
                    user = _context3.sent;
...
var getOrderByUserId = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(userId) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return _connection["default"].from('orders').select().eq('userId', userId).order('orderDate', {
            ascending: false
          });
        case 2:
  ...
  return function getOrderByUserId(_x5) {
...
var getAllOrder = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var _yield$supabase$from$5, data, error, newData;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return _connection["default"].from('orders').select().order('orderDate', {
            ascending: false
          });
        case 2:
        ...
        case 11:
          ...
          return _context7.abrupt("return", newData);
        case 13:
        case "end":
  ...
  return function getAllOrder() {
    return _ref6.apply(this, arguments);
  };
}();

// delete order by user id
var deleteOrderByUserId = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(userId) {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _connection["default"].from('orders')["delete"]().eq('userId', userId);
        case 2:
  ...
  return function deleteOrderByUserId(_x7) {
    return _ref8.apply(this, arguments);
  };
}();
// update order
var updateOrder = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(orderId, _address, _status) {
    var _yield$supabase$from$7, error;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return _connection["default"].from('orders').update({
            address: _address,
            status: _status
          }).eq('id', orderId);
        case 2:
  ...
  return function updateOrder(_x8, _x9, _x10) {
...
module.exports = {
  ...
  deleteOrderByUserId: deleteOrderByUserId,
  addOrder: addOrder,
