...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, description, price, imageUrl, status) {
    var id, _yield$supabase$from$, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          id = createId();
          _context.next = 3;
          return _connection["default"].from('product').insert([{
            id: id,
            name: name,
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _connection["default"].from('product').select().order('status', {
            ascending: false
          });
        case 2:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _connection["default"].from('product').select('*').eq('id', id);
        case 2:
...
var updateProduct = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, name, description, price, imageUrl, status) {
    var _yield$supabase$from$4, error;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _connection["default"].from('product').update({
            name: name,
            description: description,
            price: price,
            imageUrl: imageUrl,
  ...
  return function updateProduct(_x7, _x8, _x9, _x10, _x11, _x12) {
...
var deleteProduct = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return _connection["default"].from('product')["delete"]().eq('id', id);
        case 2:
  ...
  return function deleteProduct(_x13) {
